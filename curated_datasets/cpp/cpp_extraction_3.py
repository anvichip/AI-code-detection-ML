...
input_file = "curated_datasets/cpp/AI-Human-Generated-Program-Code-Dataset.json" 

ai_file = "curated_datasets/cpp/ai_cpp_3.jsonl"
human_file = "curated_datasets/cpp/human_cpp_3.jsonl"
...
print("✅ Files saved: ai_cpp_3.jsonl, human_cpp_3.jsonl")
# --- Dataset Summary ---
print("\n📊 Dataset Summary:")
