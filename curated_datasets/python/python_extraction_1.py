...
def generate_dataset(source_dir="dataset-source-codes"):
    ...
    with open("curated_datasets/python/human_python_1.jsonl", 'w', encoding='utf-8') as f_human:
        for item in human_data:
            f_human.write(json.dumps(item) + '\n')

    with open("curated_datasets/python/ai_python_1.jsonl", 'w', encoding='utf-8') as f_ai:
        for item in ai_data:
    ...
    print("Datasets 'human_python_1.jsonl' and 'ai_python_1.jsonl' created.")
    print("----------------------------------\n")
