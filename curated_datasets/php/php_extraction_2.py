...
#     with open("curated_datasets/php/human_php_1.jsonl", 'w', encoding='utf-8') as f_human:
#         for item in human_data:
#             f_human.write(json.dumps(item) + '\n')

#     with open("curated_datasets/php/ai_php_1.jsonl", 'w', encoding='utf-8') as f_ai:
#         for item in ai_data:
...
#     print("Datasets 'human_php_1.jsonl' and 'ai_php_1.jsonl' created.")
#     print("----------------------------------\n")
...
#     # Write collected data to JSONL files
#     with open("curated_datasets/java/human_java_1.jsonl", 'w', encoding='utf-8') as f_human:
#         for item in human_data:
#             f_human.write(json.dumps(item) + '\n')

#     with open("curated_datasets/java/ai_java_1.jsonl", 'w', encoding='utf-8') as f_ai:
#         for item in ai_data:
#             f_ai.write(json.dumps(item) + '\n')
...
#     print(f"Human code samples written: {len(human_data)}")
#     print(f"AI code samples written: {len(ai_data)}")
#     print("Datasets 'human_java_1.jsonl' and 'ai_java_1.jsonl' created.")
#     print("----------------------------------\n")
...
def generate_dataset(source_dir="dataset-source-codes"):
    ...
    with open("curated_datasets/php/dataset_2.jsonl", 'w', encoding='utf-8') as f_ai:
        for item in ai_data:
            f_ai.write(json.dumps(item) + '\n')
        for item in human_data:
            f_ai.write(json.dumps(item) + '\n')
